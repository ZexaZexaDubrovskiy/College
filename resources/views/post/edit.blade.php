    ...
    <div>
        ...
        <form action="{{ route('post.update', $post->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input value="{{ $post->title }}" class="form-control" id="exampleFormControlTextarea1" type="text" name="title" placeholder="Заголовок">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <input value="{{ $post->description }}" class="form-control" id="exampleFormControlTextarea1" type="text" name="description" placeholder="Описание">
                @error('description')
                <p class="text-danger">{{ $message}}</p>
                @enderror
            </div>
