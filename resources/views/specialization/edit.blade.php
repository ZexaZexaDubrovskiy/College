    ...
    <div>
        <form action="{{ route('specialization.update', $specialization->id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input value="{{ $specialization->direction }}" class="form-control" id="exampleFormControlTextarea1" type="text" name="direction" placeholder="Код специальности">
                @error('direction')
                <p class="text-danger">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input value="{{ $specialization->fullTime }}" class="form-control" id="exampleFormControlTextarea1" type="text" name="fullTime" placeholder="На базе очного обучения">
                @error('fullTime')
                <p class="text-danger">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input value="{{ $specialization->correspondence }}" class="form-control" id="exampleFormControlTextarea1" type="text" name="correspondence" placeholder="На базе заочного обучения">
            ...
            <div class="mb-3">
                ...
                <input value="{{ $specialization->entranceExam }}" class="form-control" id="exampleFormControlTextarea1" type="text" name="entranceExam" placeholder="Вступительные экзаменты">
                @error('entranceExam')
                <p class="text-danger">{{$message}}</p>
                @enderror
            </div>
