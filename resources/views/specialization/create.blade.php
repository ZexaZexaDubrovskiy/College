                ...
                <div class="mb-3">
                    <form action="{{ route('specialization.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{old('direction')}}" class="form-control" id="exampleFormControlTextarea1"
                                   type="text" name="direction" placeholder="Код специальности">
                            @error('direction')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{old('fullTime')}}" class="form-control" id="exampleFormControlTextarea1"
                                   type="text" name="fullTime" placeholder="На базе очного обучения">
                            @error('fullTime')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">На базе заочного обучения через
                                | (пример: 3г 10м | 2г 10 м)</label>
                            <input value="{{old('correspondence')}}" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{old('entranceExam')}}" class="form-control" id="exampleFormControlTextarea1"
                                   type="text" name="entranceExam" placeholder="Вступительные экзаменты">
                            @error('entranceExam')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{old('description')}}" class="form-control" id="exampleFormControlTextarea1"
                                   type="text" name="description" placeholder="Дополнительно">
                            @error('description')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{old('budget')}}" class="form-control" id="exampleFormControlTextarea1"
                                   type="text" name="budget" placeholder="Бюджет(вещественный тип)">
                            @error('budget')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
